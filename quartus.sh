...
function make_archive() {
    ...
    find ./output_files -name "*.pof" | xargs -I% cp % ./archive/$qar_dir/program_files/${project%.*}.pof
    find ./output_files -name "*.jic" | xargs -I% cp % ./archive/$qar_dir/program_files/${project%.*}.jic
}
